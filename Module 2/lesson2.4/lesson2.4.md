...
# Ответ:
Tmpfs - временное хранилище, размещаемое в оперативной памяти. Все попадающие данные в Tmpfs являются временными, т.к хранятся полностью в оперативной памяти. Tmpfs уместно использовать, например, в целях повышения производительности системы (уменьшения количества дисковых операций) или экономии ресурса SSD. 
